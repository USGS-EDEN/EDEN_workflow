...
png("./images/wading_birds_legend.png", width = 33, height = 322, type = "quartz")
par(mar=c(0, 0, 0, 0))
plot(1:10, 1:10, type = "n")
rect(0, c(0, 1.95, 3.4, 4.85, 6.3, 7.75, 9.2), 10, c(1.95, 3.4, 4.85, 6.3, 7.75, 9.2, 10.65), col = cold, border = NA)
dev.off()
setwd("..")
